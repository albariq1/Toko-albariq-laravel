    ...
    <div class="content-wrapper">
        ...
        <section class="content pr-3">
            ...
            <div id="laporan">
                ...
                <table class="table" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:20px;">
                    <tr>
                        <td></td>
                </table>
                ...
                <table align="center" class="table" style="width:800px; border:none;margin-top:5px;margin-bottom:20px;">
                    <tr>
                        <th><br /><br /></th>
                    </tr>
                    <tr>
